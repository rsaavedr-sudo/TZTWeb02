        ...
        <div className="lg:col-span-5 p-12 lg:p-20 bg-[#022c5e] text-white relative">
          <div className="relative z-10">
            ...
            <p className="text-blue-100/60 text-lg font-medium mb-16 max-w-md leading-relaxed">
              Hable con nuestros expertos y descubra cómo el modelo <span className="text-white font-bold">ZeroLoss</span> puede transformar su rentabilidad.
            </p>
        ...
        <div className="lg:col-span-7 p-12 lg:p-20 bg-white">
          <form className="space-y-8" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="space-y-3">
              <label className="block text-[#022c5e] font-black text-[11px] uppercase tracking-widest opacity-60">Volumen Mensual Estimado</label>
            ...
            <p className="text-center text-slate-400 text-[10px] font-bold uppercase tracking-widest mt-6">Garantizamos confidencialidad total de sus datos.</p>
          </form>
        </div>
      </div>
    </div>
