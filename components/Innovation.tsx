            ...
            <div className="grid sm:grid-cols-2 gap-8">
              <div className="flex flex-col gap-5 p-8 rounded-[2rem] bg-tzero-soft border border-tzero-blue/5 hover:border-tzero-blue/20 transition-all group">
                ...
                <div>
                  ...
                  <p className="text-slate-500 text-sm font-medium">Classificação instantânea entre humanos e máquinas.</p>
                </div>
              </div>
              <div className="flex flex-col gap-5 p-8 rounded-[2rem] bg-tzero-soft border border-tzero-blue/5 hover:border-tzero-blue/20 transition-all group">
                ...
                <div>
                  <h4 className="font-bold text-xl text-tzero-navy mb-2 tracking-tight">Áudio HD</h4>
                  <p className="text-slate-500 text-sm font-medium">Máxima fidelidade para uma experiência de venda premium.</p>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="space-y-8">
                <div className="bg-white/5 p-8 rounded-2xl border-l-4 border-tzero-blue backdrop-blur-md">
                  ...
                  <ul className="text-slate-400 text-xs space-y-2 font-medium">
                    <li className="flex items-center gap-2">• Apenas contatos humanos validados.</li>
                    <li className="flex items-center gap-2">• Rastreabilidade técnica e econômica total.</li>
                    <li className="flex items-center gap-2">• Alinhado às normas ANATEL e LGPD.</li>
                  </ul>
                </div>
                ...
                <div className="bg-black/10 p-8 rounded-2xl opacity-60 border border-white/5">
                  ...
                  <h5 className="text-xl font-bold mb-3 text-slate-300">Cobrança por Minutos</h5>
                  <p className="text-slate-500 text-xs leading-relaxed font-medium">Você paga por silêncios, erros de rede e gravações. Sem controle real de ROI.</p>
                </div>
              </div>
            </div>
          </div>
