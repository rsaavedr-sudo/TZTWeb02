...
const Innovation: React.FC = () => {
  return (
    <div className="py-24 bg-white overflow-hidden relative" id="tecnologia">
        ...
        <div className="grid lg:grid-cols-2 gap-24 items-center">
          <div>
            ...
            <p className="text-slate-500 text-lg mb-12 leading-relaxed max-w-xl font-medium">
              Utilizamos IA Neural y procesamiento en tiempo real para filtrar ruidos de red y máquinas de contestar en menos de 100ms.
            </p>
          ...
          <div className="relative">
            <div className="bg-tzero-navy rounded-[3rem] p-12 shadow-[0_40px_80px_-15px_rgba(11,28,63,0.3)] text-white">
              ...
              <div className="space-y-8">
                <div className="bg-white/5 p-8 rounded-2xl border-l-4 border-tzero-blue backdrop-blur-md">
                  ...
                  <h5 className="text-xl font-bold mb-3">Tarifación Inteligente</h5>
                  <ul className="text-slate-400 text-xs space-y-2 font-medium">
                    ...
                    <li className="flex items-center gap-2">• Trazabilidad técnica y económica total.</li>
